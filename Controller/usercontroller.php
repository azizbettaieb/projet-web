...
class UserController {
    ...
    public function login($email, $password, $otp = null) {
        ...
        if ($user && password_verify($password, $user['password'])) {
            ...
            if (!empty($user['twofa_secret'])) {
                if (!$otp) {
                    ...
                    header("Location: ../front office/verify2fa.php");
                    exit();
                }
                ...
                if (!$checkResult) {
                    header("Location: ../front office/login.php?error=otp_failed");
                    exit();
                }
            }
            ...
            if ($_SESSION['user_role'] == 1) {
                header("Location: ../../View/back/pages/app-profile.php");
            } else {
        ...
        header("Location: ../front office/login.php?error=login_failed");
    }
