...
<!-- Navbar End -->
            ...
            <div class="row gx-5 justify-content-start">
                <div class="col-lg-7">
                    <div class="border-start border-5 border-dark ps-5 mb-5">
                        <h1 class="display-5 text-uppercase text-white mb-0"> Login</h1>
                    </div>
                    ...
                    <div class="bg-light text-center pt-4">
                        ...
                        <form name="userForm" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                                ...
                                <h1 class="display-4 text-white mb-0">
                                    <small class="align-top"
                                        ...
                                        <div class="input-group">
                                            <input type="email" class="form-control p-3"  name="email" placeholder="Your Email" required="required" data-validation-required-message="Please enter your email" />
                            ...
                            <div class="text-center bg-dark p-4 mb-2">
                                <h1 class="display-4 text-white mb-0">
                                    <small class="align-top"
                                        style="font-size: 22px; line-height: 45px;">password</small>
                                        <div class="input-group">
                                        <input type="password" class="form-control p-3" name="password" placeholder="password" required="required" data-validation-required-message="Please enter a password" />
    ...
    <br></br>
    <p class="text-center">mot de passe oublié? <a href="forget.php">cliquez ici </a> 
    </p>
    </div>
