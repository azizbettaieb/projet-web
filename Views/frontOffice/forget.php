...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($user) {
        ...
        // Envoyer l'e-mail
        $resetLink = "http://localhost/web/Views/FrontOffice/reset.php?token=$token";
...
;
    ...
    try {
        ...
        $mail->Password = 'qbqk xlni jduu bocl'; // Votre mot de passe
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port = 587;

        // Informations sur l'expéditeur et le destinataire
        $mail->setFrom('med.achi94@gmail.com', 'aziz bettaieb');
        $mail->addAddress($to);
            ...
            <div class="row gx-5 justify-content-start">
                <div class="col-lg-7">
                    <div class="border-start border-5 border-dark ps-5 mb-5">
                        <h1 class="display-5 text-uppercase text-white mb-0"> forget your password ? no problem</h1>
                    </div>
            ...
            <div class="row gx-0">
                ...
                <?php if (!isset($_SESSION['user_id'])) {?>
                    <div class="bg-light text-center pt-4">
                        <h2 class="text-uppercase">enter your email</h2>
                        <h6 class="text-body mb-5">please enter your informations</h6>
                        <form name="resetForm" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                            <div class="text-center bg-dark p-4 mb-2">
                                <h1 class="display-4 text-white mb-0">
                                    <small class="align-top"
                                        style="font-size: 22px; line-height: 45px;">Email</small>
                                        <div class="input-group">
                                            <input class="form-control p-3"  type="email" id="email" name="email" placeholder="Your Email" required="required" data-validation-required-message="Please enter your email" />
                            ...
                            <button class="btn btn-primary py-3 px-5" type="submit">reset</button>
                                </div>   
                        </form>
