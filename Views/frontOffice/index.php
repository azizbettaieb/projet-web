        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="display-1 text-uppercase text-dark mb-lg-4">Duty Free</h1>
                    <h1 class="text-uppercase text-danger mb-lg-4">Make Your final purchases</h1>
                    <p class="fs-4 text-danger mb-lg-4">free tour in duty free</p>
            ...
            <div class="row gx-5">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded" src="img/2.jpg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="border-start border-5 border-primary ps-5 mb-5">
                        <h6 class="text-primary text-uppercase">About Us</h6>
                        <h1 class="display-5 text-uppercase mb-0">We have everything you need !</h1>
                    </div>
            ...
            <div class="row g-5">
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                            <img src="img/logo.jpg" alt="Logo" class="me-2" style="width:100px; height:100px; object-fit:contain; border-radius:50%;">
                                                  <div>
                            <h5 class="text-uppercase mb-3">Perfumes</h5>
                ...
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        <img src="img/logo.jpg" alt="Logo" class="me-2" style="width:100px; height:100px; object-fit:contain; border-radius:50%;">
                        <div>
                            <h5 class="text-uppercase mb-3">alcohol</h5>
                            <p>Kasd dolor no lorem sit tempor at justo rebum rebum stet justo elitr dolor amet sit</p>
                            <a class="text-primary text-uppercase" href="">Read More<i class="bi bi-chevron-right"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        <img src="img/logo.jpg" alt="Logo" class="me-2" style="width:100px; height:100px; object-fit:contain; border-radius:50%;">
                        <div>
                            <h5 class="text-uppercase mb-3">cosmetics</h5>
                            <p>Kasd dolor no lorem sit tempor at justo rebum rebum stet justo elitr dolor amet sit</p>
                            <a class="text-primary text-uppercase" href="">Read More<i class="bi bi-chevron-right"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        <img src="img/logo.jpg" alt="Logo" class="me-2" style="width:100px; height:100px; object-fit:contain; border-radius:50%;">
                        <div>
                            <h5 class="text-uppercase mb-3">chocolates</h5>
                            <p>Kasd dolor no lorem sit tempor at justo rebum rebum stet justo elitr dolor amet sit</p>
                            <a class="text-primary text-uppercase" href="">Read More<i class="bi bi-chevron-right"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        <img src="img/logo.jpg" alt="Logo" class="me-2" style="width:100px; height:100px; object-fit:contain; border-radius:50%;">
                        <div>
                            <h5 class="text-uppercase mb-3">snacks</h5>
                            <p>Kasd dolor no lorem sit tempor at justo rebum rebum stet justo elitr dolor amet sit</p>
                            <a class="text-primary text-uppercase" href="">Read More<i class="bi bi-chevron-right"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="service-item bg-light d-flex p-4">
                        <img src="img/logo.jpg" alt="Logo" class="me-2" style="width:100px; height:100px; object-fit:contain; border-radius:50%;">
                        <div>
                            <h5 class="text-uppercase mb-3">many more !</h5>
                            <p>Kasd dolor no lorem sit tempor at justo rebum rebum stet justo elitr dolor amet sit</p>
                            <a class="text-primary text-uppercase" href="">Read More<i class="bi bi-chevron-right"></i></a>
                        </div>
                    </div>
