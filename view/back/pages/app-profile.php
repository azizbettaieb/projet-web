...
<body class="g-sidenav-show bg-gray-100">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="../pages/tables.html">
            <span class="nav-link-text ms-1">liste admin</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link active bg-gradient-dark text-white" href="../pages/app-profile.php">
  ...
  <div class="main-content position-relative max-height-vh-100 h-100">
    ...
    <div class="container-fluid px-2 px-md-4">
      ...
      <img src="../../uploads/<?php echo $_SESSION['photo']; ?>" alt="profile_image" class="w-100 border-radius-lg shadow-sm" >
  <?php else: ?>
  ...
  <?php endif; ?>
          ...
          <div class="col-auto my-auto">
            <div class="h-100">
              <h5 class="mb-1">
              <?php echo $_SESSION['user_name']; ?> <?php echo $_SESSION['user_lastname']; ?>              </h5>
                ...
                <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                  <div class="card card-blog card-plain">
                    <div class="card-header p-0 m-2">
                      <a class="d-block shadow-xl border-radius-xl">
                      <?php if ($_SESSION['photo']): ?>
      <img src="../uploads/<?php echo $_SESSION['photo']; ?>" class="img-fluid rounded-circle" alt="Photo de profil" width="450 ">
  <?php else: ?>
      <h5 class="text-white mb-3">   Pas de photo </h5>
  <?php endif; ?>                      </a>
                    </div>
