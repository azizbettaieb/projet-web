...
$pdo = config::getConnexion();
        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2"
          ...
          <a class="nav-link text-dark" href="../pages/data-user.php">
            <span class="nav-link-text ms-1">liste utilisateur</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="../pages/app-profile.php">
                            <i class="material-symbols-rounded opacity-5">person</i>
                            <span class="nav-link-text ms-1">Profile</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="../pages/logoutadmin.php">
                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center">
                                    <h6 class="text-white text-capitalize ps-3">table utilisateur </h6>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="ajouterutilisateur.php" class="btn btn-outline-light me-3">
    ...
    <?php endif; ?>
                    ...
                    <td>
                        <a href="update-user.php?id=<?= $user->getId() ?>">Edit</a>
