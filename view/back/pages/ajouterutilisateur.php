...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $role= $_POST['role'];
    $statusCompte= $_POST['statuscompte'];
...
if (isset($_FILES['photo']) && $_FILES['photo']['error'] === UPLOAD_ERR_OK) {
    ...
    if ($password === $confirmPassword) {
        if ($controller->createUser($name, $lastName, $email, $password, $role , $statusCompte, $photoName)) {
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <div class="form-row">
        <div class="form-col">
            <div class="mb-3">
                <input type="text" class="form-control" name="name" id="name" placeholder="Prénom" required>
            </div>
        </div>
