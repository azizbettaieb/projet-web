...
function confirmDelete(id) {
    if (confirm('Voulez-vous vraiment supprimer ce transport ?')) {
        window.location.href = 'supprimertransport.php?id=' + id;
    }
}
...
var categorieChart = new Chart(ctx, {
    ...
    options: {
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: 'Distribution des Transports par Catégorie',
                color: 'white',
                font: {
                    size: 18,
                    weight: 'bold'
                        ...
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="me-3">
                                        <input type="text" id="searchTransport" class="form-control form-control-sm bg-white text-dark" placeholder="Rechercher...">
                                    </div>
                                    <div class="me-3">
                                    ...
                                    <a href="ajoutertransport.php" class="btn btn-outline-light me-3">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th
                                                ...
                                                zone </th>
                                             <th
                                                 class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 sortable-header" data-sort="cout">
                                                 cout
...
if (!empty($listeTransport)) {
    foreach ($listeTransport as $index => $transport) {
        echo "<tr>
            ...
            <td class='align-middle text-center text-sm' data-cout='" . htmlspecialchars($transport['cout_moyen']) . "'>
...
?>
            <div class="row">
                <div class="col-12">
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center">
                                <h6 class="text-white text-capitalize ps-3">Table Catégorie</h6>
                                <a href="ajouter_categorie.php" class="btn btn-outline-light me-3">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const searchInput = document.getElementById('searchTransport');
    ...
    <script>
        // Sorting functionality for transport table
        document.addEventListener('DOMContentLoaded', function() {
            const coutHeader = document.querySelector('.sortable-header[data-sort="cout"]');
            
            if (coutHeader) {
                coutHeader.addEventListener('click', function() {
                    ...
                    // Sort rows
                    rows.sort((a, b) => {
                        const coutA = parseFloat(a.querySelector('td[data-cout]').getAttribute('data-cout'));
                        const coutB = parseFloat(b.querySelector('td[data-cout]').getAttribute('data-cout'));
                        return newDirection === 'asc' ? coutA - coutB : coutB - coutA;
                    });
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            toggleEcologiqueBtn.addEventListener('click', function() {
                ...
                // Filter rows
                rows.forEach(row => {
                    const ecologiqueCell = row.querySelector('td:nth-child(8) .badge');
                    const isEcologique = ecologiqueCell.textContent === 'Oui';
