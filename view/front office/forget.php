...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($user) {
        ...
        // Envoyer l'e-mail
        $resetLink = "http://localhost/urbanisme/View/front office/reset.php?token=$token";
		...
		<div class="col-xl-5 offset-xl-3">
			...
			<div class="login-register-page">
				...
				<div class="welcome-text">
					...
					<span>after entering your email check your mailbox</span>
				</div>
				...
				<form  name="resetForm"   method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
					<div class="input-with-icon-left">
						...
						<!-- Button -->
				<button class="button full-width button-sliding-icon ripple-effect margin-top-10" type="submit" >send email <i class="icon-material-outline-arrow-right-alt"></i></button>
